// This script will be loaded globally and can be called from anywhere
window.initializeEvMap = function(elementId, options = {}) {
  const {
  ...
  setTimeout(() => {
    ...
    // Store map instance on window for later reference
    window.evMap = map;
